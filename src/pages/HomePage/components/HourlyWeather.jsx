        ...
        <div className="hourlyWeather">
            <section className="hourlyWeather__section">
                <ul className="hourlyWeather__list">
                    <li className="hourlyWeather__item">
                        <a href="#">
                            <p className="hourlyWeather__item-time">Now</p>
                            <div className="hourlyWeather__item-data">
                                ...
                                <p className="hourlyWeather__item-temp">25</p>
                            </div>
                        </a>
                    </li>
                    <li className="hourlyWeather__item">
                        <a href="#">
                            <p className="hourlyWeather__item-time">2 AM</p>
                            <div className="hourlyWeather__item-data">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                    ...
                    <li className="hourlyWeather__item">
                        <a href="#">
                            <p className="hourlyWeather__item-time">3 AM</p>
                            <div className="hourlyWeather__item-data">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                    ...
                    <li className="hourlyWeather__item">
                        <a href="#">
                            <p className="hourlyWeather__item-time">4 AM</p>
                            <div className="hourlyWeather__item-data">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                    ...
                    <li className="hourlyWeather__item">
                        <a href="#">
                            <p className="hourlyWeather__item-time">5 AM</p>
                            <div className="hourlyWeather__item-data">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
            ...
            <section className="hourlyWeather__section">
                <ul className="hourlyWeather__list">
                    <li className="hourlyWeather__item">
                        <a href="#">
                            <p className="hourlyWeather__item-time">6 AM</p>
                            <div className="hourlyWeather__item-data">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                    ...
                    <li className="hourlyWeather__item">
                        <a href="#">
                            <p className="hourlyWeather__item-time">7 AM</p>
                            <div className="hourlyWeather__item-data">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                    ...
                    <li className="hourlyWeather__item">
                        <a href="#">
                            <p className="hourlyWeather__item-time">8 AM</p>
                            <div className="hourlyWeather__item-data">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                    ...
                    <li className="hourlyWeather__item">
                        <a href="#">
                            <p className="hourlyWeather__item-time">9 AM</p>
                            <div className="hourlyWeather__item-data">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                    ...
                    <li className="hourlyWeather__item">
                        <a href="#">
                            <p className="hourlyWeather__item-time">10 AM</p>
                            <div className="hourlyWeather__item-data">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
