const MainWeatherInformation = ({ conditions }) => {
    return (
        <div className="mainInformation">
            ...
            <section className="mainInformation__conditions">
                ...
                <p className="mainInformation__conditions-temp">25</p>
            </section>
            <section className="mainInformation__description">
                ...
                <p className="mainInformation__description-text">21 Oct 2019</p>
                <p className="mainInformation__description-text">
                    Feels like 28 | Sunset 18:20
                </p>
            </section>
        </div>
    );
