        ...
        <div className="daysWeather">
            ...
            <ul className="daysWeather__list">
                <li className="daysWeather__item">
                    <a href="#">
                        <p className="daysWeather__item-day">Today</p>
                        ...
                        <div className="daysWeather__item-temps">
                            ...
                            <div className="daysWeather__item-humidity">
                                <div className="daysWeather__item-humidity--line"></div>
                            </div>
                ...
                <li className="daysWeather__item">
                    <a href="#">
                        <p className="daysWeather__item-day">Thu</p>
                ...
                <li className="daysWeather__item">
                    <a href="#">
                        <p className="daysWeather__item-day">Fri</p>
                ...
                <li className="daysWeather__item">
                    <a href="#">
                        <p className="daysWeather__item-day">Sat</p>
                ...
                <li className="daysWeather__item">
                    <a href="#">
                        <p className="daysWeather__item-day">Sun</p>
                ...
                <li className="daysWeather__item">
                    <a href="#">
                        <p className="daysWeather__item-day">Mon</p>
                ...
                <li className="daysWeather__item">
                    <a href="#">
                        <p className="daysWeather__item-day">Tue</p>
                ...
                <li className="daysWeather__item">
                    <a href="#">
                        <p className="daysWeather__item-day">Wed</p>
